...
use App\Http\Requests\Course\GenerateCurriculumRequest;
...
use App\Http\Requests\Course\SortSectionsRequest;
use App\Http\Requests\Course\UpdateRequest;
use App\Http\Requests\Course\EnrollmentSeederRequest;
...
class CourseController extends Controller
{
    ...
    public function sortSections(SortSectionsRequest $request)
    {
        return $request->handle();
    }

    public function generateCurriculum(GenerateCurriculumRequest $request)
    {
        return $request->handle();
    }

    public function enrollmentSeeder(EnrollmentSeederRequest $request)
    {
        return $request->handle();
    }
}

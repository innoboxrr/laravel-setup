...
namespace App\Notifications\TrackingEvent;

use Maatwebsite\Excel\Facades\Excel;
use App\Exports\TrackingEventsExports;
...
class ExportNotification extends Notification
{
    ...
    private function createExport()
    {
        ...
        Excel::store(new TrackingEventsExports($this->data), $this->path, config('app.export_disk', 's3'));
    ...
    private function getSubject()
    {
        ...
        return env('APP_NAME') . ' | TrackingEvent export notification';

    ...
    <div>
        ...
        <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700 rounded-xl" id="notification-dropdown">
            ...
            <div class="h-96 overflow-auto hide-scrollbar">
                ...
                <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600 hover:no-underline">
                    ...
                    <div class="pl-3 w-full">
                        <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400"> Nuevo mensaje de <span class="font-semibold text-gray-900 dark:text-white">Bonnie Green</span>: "Hola que tal, ya enviaste la presentación?" </div>
                        <div class="text-xs font-medium text-primary-600 dark:text-primary-500"> hace un minuto </div>
                    </div>
                </a>
                ...
                <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600 hover:no-underline">
                    ...
                    <div class="pl-3 w-full">
                        <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                            <span class="font-semibold text-gray-900 dark:text-white">Jese leos</span> y <span class="font-medium text-gray-900 dark:text-white">otros 5</span> te han mencionado.
                        </div>
                        <div class="text-xs font-medium text-primary-600 dark:text-primary-500"> hace 10 minutes </div>
                    </div>
                </a>
                ...
                <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600 hover:no-underline">
                    ...
                    <div class="pl-3 w-full">
                        <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                            <span class="font-semibold text-gray-900 dark:text-white">Joseph Mcfall</span> y <span class="font-medium text-gray-900 dark:text-white">otros 15</span> han enviado su tarea en <b>Matemáticas II</b>.
                        </div>
                        <div class="text-xs font-medium text-primary-600 dark:text-primary-500"> hace 44 minutos  </div>
                    </div>
                </a>
                ...
                <a href="#" class="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600 hover:no-underline">
                    ...
                    <div class="pl-3 w-full">
                        <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                            <span class="font-semibold text-gray-900 dark:text-white">Leslie Livingston</span> te ha mencionado en una publicación del foro: <span class="font-medium text-primary-600 dark:text-primary-500">@bonnie.green</span> que debemos enviar?
                        </div>
                        <div class="text-xs font-medium text-primary-600 dark:text-primary-500"> hace 1 hora  </div>
                    </div>
                </a>

                <a href="#" class="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 hover:no-underline">
                    <div class="flex-shrink-0 relative">
                    ...
                    <div class="pl-3 w-full">
                        <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                            <span class="font-semibold text-gray-900 dark:text-white">Robert Brown</span> Han solicitado una revisón en "Arte Contemporáneo II".
                        </div>
                        <div class="text-xs font-medium text-primary-600 dark:text-primary-500"> hace 3 horas </div>
                    </div>
                </a>
                ...
                <a href="#" class="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 hover:no-underline">
                    ...
                    <div class="pl-3 w-full">
                        <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">
                            <span class="font-semibold text-gray-900 dark:text-white">Robert Brown f</span> Han solicitado una revisón en "Arte Contemporáneo II".
                        </div>
                        <div class="text-xs font-medium text-primary-600 dark:text-primary-500"> hace 3 horas </div>
                    </div>
                </a>

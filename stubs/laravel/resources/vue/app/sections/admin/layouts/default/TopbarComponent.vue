<template>
    ...
    <nav class="bg-white border-b border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 md:left-64 right-0 top-0 z-50">
        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex justify-start items-center">
                ...
                <form action="#" method="GET" class="lg:pl-2 hidden md:block">

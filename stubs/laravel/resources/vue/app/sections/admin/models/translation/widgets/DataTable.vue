<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="translationExternalFilters"
...
<script>
	...
	import FilterForm from '@models/translation/forms/FilterForm.vue'
	import * as model from '@models/translation' 

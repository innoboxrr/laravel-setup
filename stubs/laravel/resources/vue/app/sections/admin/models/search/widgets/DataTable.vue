<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="searchExternalFilters"
...
<script>
	...
	import FilterForm from '@models/search/forms/FilterForm.vue'
	import * as model from '@models/search' 

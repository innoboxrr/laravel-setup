<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="languageExternalFilters"
...
<script>
	...
	import FilterForm from '@models/language/forms/FilterForm.vue'
	import * as model from '@models/language' 

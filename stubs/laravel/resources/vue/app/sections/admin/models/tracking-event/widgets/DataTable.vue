<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="trackingEventExternalFilters"
...
<script>
	...
	import FilterForm from '@models/tracking-event/forms/FilterForm.vue'
	import * as model from '@models/tracking-event' 

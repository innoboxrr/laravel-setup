<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="optionExternalFilters"
...
<script>
	...
	import FilterForm from '@models/option/forms/FilterForm.vue'
	import * as model from '@models/option' 

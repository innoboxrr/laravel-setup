<template>
	...
	<data-table
		...
		policy-method="get"
		:model="model"
		:external-filters="permissionExternalFilters"
...
<script>
	...
	import FilterForm from '@models/permission/forms/FilterForm.vue'
	import * as model from '@models/permission' 

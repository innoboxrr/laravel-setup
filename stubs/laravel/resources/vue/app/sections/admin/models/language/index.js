...
export const API_ROUTE_PREFIX = 'api.language.'; // Reemplaza con la ruta adecuada
...
export const getJson = (modelId) => {
    return makeHttpRequest('get', route(API_ROUTE_PREFIX + 'get.json'), {
        _token: CSRF_TOKEN,
        language_id: modelId,
    }, {}, 1, 1500);
};

export const updateJson = (modelId, data) => {
    return makeHttpRequest('post', route(API_ROUTE_PREFIX + 'update.json'), {
        _token: CSRF_TOKEN,
        ...data,
        language_id: modelId,
    }, {}, 0, 1500);

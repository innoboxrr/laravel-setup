<template>
    <div
        ...
        class="bg-gray-900 pt-24 sm:pt-32 pb-24">
            ...
            <ul 
                ...
                <li
                    ...
                    <ul role="list" class="mt-6 flex justify-center gap-x-6">
                        <li>
                            <a :href="person.links.twitter" class="text-gray-400 hover:text-gray-300">
                        ...
                        <li>
                            <a :href="person.links.linkedin" class="text-gray-400 hover:text-gray-300">

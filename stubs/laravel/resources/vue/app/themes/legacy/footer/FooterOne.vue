        ...
        <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
            ...
            <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
                ...
                <form 
                    ...
                    <label for="email-address" class="sr-only">
                        {{ props.newsletter.input_placeholder }}
                    </label>
                    <input 
                        type="email" 
                        name="email" 
                        ...
                        :placeholder="props.newsletter.input_placeholder" 
                        v-model="email" />
            ...
            <div class="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
                ...
                <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
                    &copy; {{ formatDate(Date(), 'YYYY') }}, {{ appName }}. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
...
export default {
    ...
    data() {
        return {
            ...
            social: [
                {
                    name: 'Facebook',
                    href: this.props.social_links.facebook,
                ...
                {
                    name: 'Instagram',
                    href: this.props.social_links.instagram,
                    icon: markRaw(defineComponent({
                        render: () =>
                            h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
                                h('path', {
                ...
                {
                    name: 'X',
                    href: this.props.social_links.twitter,
                    icon: markRaw(defineComponent({
                        render: () =>
                            h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
                                h('path', {
                ...
                {
                    name: 'GitHub',
                    href: this.props.social_links.github,
                    icon: markRaw(defineComponent({
                        render: () =>
                            h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
                                h('path', {
                ...
                {
                    name: 'YouTube',
                    href: this.props.social_links.youtube,
                    icon: markRaw(defineComponent({
                        render: () =>
                            h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
                                h('path', {
    ...
    methods: {
        async mailchimpSubscribe() {
            const response = await axios.post('/mailchimp-subscribe', {
                email: this.email
            });
            this.email = '';    
            window.scrollTo(0, 0);
